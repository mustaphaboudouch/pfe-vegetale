		...
		<div id="sidebar-wrapper">
			...
			<div class="my-logo">
				...
				<ul class="my-menu">
					...
					<li><a class="active"><i class="fa fa-pepper-hot"></i> Mes Varietés</a></li>
					...
					<div class="container my-content">
						...
						<div class="row my-header">
							...
							<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
								<a href="pages/add-variete.php" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Ajouter</a>
							</div>
						</div>
						...
						<div class="row">
							...
							<form>
								<div class="form-row my-search-input">
									...
									<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                        <select class="form-control custom-select" id="select-etat" onchange="selectEtat(); " >
									...
									<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
								        <input type="text" class="form-control" placeholder="Search for vegetable varieties" aria-describedby="search-btn" id="my-search" onkeyup="searchVarieteEtat();">
									</div>
								</div>
							</form>
							</div>
