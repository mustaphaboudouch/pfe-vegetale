<?php
	...
	require_once '../includes/add-variete-func.php';
				...
				<div class="container my-content">
					...
					<div class="row my-header">
						<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
							<h4><i class="fa fa-plus-circle"></i> Ajouter Varieté</h4>
							<p class="text-muted">Espece, Varieté et Image</p>
						</div>
					</div>
				    ...
				    <div class="row my-add-variete">
				        <div class="col-12">
                            <form action="" method="post" id="big_form" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="variete" name="variete" placeholder="Nom du varieté">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <div class="custom-file">
                                            ...
                                            <label style="" class="custom-file-label" for="customFile">Selectionner l'image du varieté</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                        <button type="submit" class="btn btn-success btn-block" name="insert_variete" id="Submit" onclick="big_form_submit();">Enregistrer Variete</button>
                                    </div>
                                </div>
