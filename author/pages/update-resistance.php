...
require_once '../includes/update-resistance-func.php';

//needed: id of user and id of variete an id of resistance
...
if(isset($_POST['edit_resistance'])){
    $_SESSION['id_resistance'] = $_POST['id_resistance'];
}
...
if(isset($_POST['update_resistance'])){
    updateResistance();
}
				...
				<div class="container my-content">
				    ...
				    <div class="row my-header">
				        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
				            <h4><i class="fa fa-edit"></i> Modifier Pathotype</h4>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12">
                                        <select class="custom-select" id="pathotype" name="pathotype">
                                            ...
                                            <?php selectedPathotype($resistance['ID_PATHOTYPE']);  ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <select class="custom-select" id="resistance" name="resistance">
                                            ...
                                            <?php selectedResistance($resistance['NOM_RESISTANCE']); ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                        <button type="submit" class="btn btn-success btn-block"  name="update_resistance" onclick="form_submit();">Enregistrer</button>
                                    </div>
                                </div>
