...
require_once '../includes/update-notation-func.php';
//needed: id of user and id of variete and id of notation
...
if(isset($_POST["edit_notation"])){
	$_SESSION['id_notation'] = checkInput($_POST['id_notation']);
}
...
if(isset($_POST['update_notation'])){
	updateNotation();
}
?>
				...
				<div class="container my-content">
				    ...
				    <div class="row my-header">
				        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
				            <h4><i class="fa fa-edit"></i> Modifier Notation</h4>
				    ...
				    <div class="row my-add-variete">
				        <div class="col-12">
                            <form action="" method="post" id="big_form">
                                ...
                                <div class="form-row">
                                    <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12">
                                        <select class="custom-select" id="organe" name="organe">
											...
											<?php selectedOrgane($notation['ID_ORGANE']);?>                                        </select>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12">
                                        <select class="custom-select" id="caractere" name="caractere">
											...
											<?php selectedCaractere($notation['ID_CARACTERE']); ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div class="form-row">
                                    <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12">
                                        <select class="custom-select" id="niveau" name="niveau">
											...
											<?php selectedNiveauExpression($notation['ID_NIVEAU_EXPRESSION'])  ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div class="form-row">
                                    <div class="col-12">
									<input type="text" class="form-control notation" <?php if($notation == null) echo "disabled";?> placeholder="notation" value="<?php echo $notation['NOTATION']; ?>" id="notation" name="notation">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
									<button type="submit" class="btn btn-success btn-block " name="update_notation" onclick="big_form_submit();">Enregistrer</button>
                                    </div>
                                </div>
